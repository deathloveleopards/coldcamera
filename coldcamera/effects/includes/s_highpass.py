...
class HighPassEffect(EffectBase):
    author: str = "serh11chyrva"

    def __init__(self, name="High Pass Filter"):
        super().__init__(
            name,
    ...
    def apply(self, input_data: Processable) -> Processable:
        ...
        board = Pedalboard([HighpassFilter(cutoff_frequency_hz=self.get_parameter("cutoff_frequency_hz"))])
