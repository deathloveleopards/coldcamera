...
class ChorusEffect(EffectBase):
    ...
    def __init__(self, name="Chorus"):
        super().__init__(
            ...
            layout_elements=[
                ParameterSlider("rate", "Rate", min_value=0.5, max_value=4.0, step=0.1),
    ...
    def apply(self, input_data: Processable) -> Processable:
        ...
        board = Pedalboard([Chorus(rate_hz=self.get_parameter("rate"), depth=self.get_parameter("depth"))])
